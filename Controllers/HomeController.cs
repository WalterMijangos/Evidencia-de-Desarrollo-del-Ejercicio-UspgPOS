...
namespace UspgPOS.Controllers
{
	public class HomeController : Controller
	{
		...
		public IActionResult Dashboard()
		{
			...
			//Variable para crear grupo de cantidad de empleados por departamento
            var cantidadEmpleadosDepartamentos = empleados
				.GroupBy(empleado => empleado.Departamento)
				.Select(grupo => new { Departamento = grupo.Key,
